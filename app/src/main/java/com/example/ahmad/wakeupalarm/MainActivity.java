...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* get the intent from the app before */
    ...
    public void setAlarm(int TimeToAlarm){
        ...
        PendingIntent pendAlarmIntent = PendingIntent.getBroadcast(this, 0, AlarmIntent, 0);
        AlarmManager alarmManager=(AlarmManager)getSystemService(Context.ALARM_SERVICE);
        alarmManager.set(AlarmManager.RTC_WAKEUP,
                alarmtime, PendingIntent.getBroadcast(this,1,AlarmIntent,PendingIntent.FLAG_UPDATE_CURRENT));
